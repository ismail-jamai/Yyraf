    ...
    <footer className="bg-footer-bg text-white py-12 md:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:info@dropshipping.ma" className="hover:text-white transition-colors">
                  info@dropshipping.ma
                </a>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 ml-2 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+212612345678" className="hover:text-white transition-colors">
                  +212 612 345 678
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-reverse space-x-4">
              <a
                ...
                className="w-12 h-12 bg-white bg-opacity-10 rounded-full flex items-center justify-center hover:bg-primary transition-colors"
                aria-label="Facebook"
              >
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>© 2025 دروبشيبينغ المغرب. جميع الحقوق محفوظة.</p>
        </div>
      </div>
    </footer>
  )
